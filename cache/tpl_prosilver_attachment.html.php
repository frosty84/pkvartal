<?php if (!defined('IN_PHPBB')) exit; $__file_count = (isset($this->_tpldata['_file'])) ? sizeof($this->_tpldata['_file']) : 0;if ($__file_count) {for ($__file_i = 0; $__file_i < $__file_count; ++$__file_i){$__file_val = &$this->_tpldata['_file'][$__file_i]; if ($__file_val['S_DENIED']) {  ?>
	...
	<?php } else { if ($__file_val['S_THUMBNAIL']) {  ?>
		...
		<dl class="file">
			<dt class="attach-image"><img src="<?php echo $__file_val['U_INLINE_LINK']; ?>" alt="<?php echo $__file_val['DOWNLOAD_NAME']; ?>" title="<?php if ($__file_val['COMMENT_CLEAN']) {  echo $__file_val['COMMENT_CLEAN']; ?> / <?php } echo $__file_val['DOWNLOAD_NAME']; ?>" onclick="viewableArea(this);" /></dt>
		...
		<dl class="file">
			<dt><?php if ($__file_val['UPLOAD_ICON']) {  echo $__file_val['UPLOAD_ICON']; ?> <?php } ?><a class="postlink" href="<?php echo $__file_val['U_DOWNLOAD_LINK']; ?>" title="<?php if ($__file_val['COMMENT_CLEAN']) {  echo $__file_val['COMMENT_CLEAN']; ?> / <?php } echo $__file_val['DOWNLOAD_NAME']; ?>"><?php echo $__file_val['DOWNLOAD_NAME']; ?></a></dt>
			<?php if ($__file_val['COMMENT']) {  ?><dd><em><?php echo $__file_val['COMMENT']; ?></em></dd><?php } ?>
