...
<meta name="keywords" content="Пражский,квартал,Комплек,ЖК,Празький,Новостройки,Жилье,Киев,Борщаговка,квартира" />
<meta name="description" content="<?php if ($this->_rootref['SCRIPT_NAME'] == ("viewforum")) {  echo (isset($this->_rootref['FORUM_DESC'])) ? $this->_rootref['FORUM_DESC'] : ''; } else if ($this->_rootref['SCRIPT_NAME'] == ("viewtopic")) {  echo (isset($this->_rootref['MESSAGE_TRIMMED'])) ? $this->_rootref['MESSAGE_TRIMMED'] : ''; } else { ?>Неофициальный форум ЖК Пражский Квартал, Неофіційний форум ЖК Празький Квартал, Жилье в киеве, новостройки Киева, Петропавловская борщаговка, Обсуждение Пражского Квартала<?php } ?>" />
<?php echo (isset($this->_rootref['META'])) ? $this->_rootref['META'] : ''; ?>

<title><?php if ($this->_rootref['S_IN_MCP']) {  echo ((isset($this->_rootref['L_MCP'])) ? $this->_rootref['L_MCP'] : ((isset($user->lang['MCP'])) ? $user->lang['MCP'] : '{ MCP }')); ?> &bull; <?php } else if ($this->_rootref['S_IN_UCP']) {  echo ((isset($this->_rootref['L_UCP'])) ? $this->_rootref['L_UCP'] : ((isset($user->lang['UCP'])) ? $user->lang['UCP'] : '{ UCP }')); ?> &bull; <?php } if ($this->_rootref['SCRIPT_NAME'] == ("index")) {  echo (isset($this->_rootref['SITENAME'])) ? $this->_rootref['SITENAME'] : ''; ?> - <?php echo (isset($this->_rootref['SITE_DESCRIPTION'])) ? $this->_rootref['SITE_DESCRIPTION'] : ''; ?>

   <?php } else if ($this->_rootref['SCRIPT_NAME'] == ("viewforum")) {  echo (isset($this->_rootref['FORUM_NAME'])) ? $this->_rootref['FORUM_NAME'] : ''; ?> | <?php echo (isset($this->_rootref['SITENAME'])) ? $this->_rootref['SITENAME'] : ''; ?>

   <?php } else if ($this->_rootref['SCRIPT_NAME'] == ("viewtopic")) {  echo (isset($this->_rootref['TOPIC_TITLE'])) ? $this->_rootref['TOPIC_TITLE'] : ''; ?> | <?php echo (isset($this->_rootref['SITENAME'])) ? $this->_rootref['SITENAME'] : ''; ?>

   <?php } else if ($this->_rootref['SCRIPT_NAME'] == ("posting")) {  if ($this->_rootref['S_USER_LOGGED_IN']) {  if ($this->_rootref['TOPIC_TITLE']) {  echo ((isset($this->_rootref['L_TOPIC'])) ? $this->_rootref['L_TOPIC'] : ((isset($user->lang['TOPIC'])) ? $user->lang['TOPIC'] : '{ TOPIC }')); ?> - <?php echo (isset($this->_rootref['TOPIC_TITLE'])) ? $this->_rootref['TOPIC_TITLE'] : ''; } else { echo ((isset($this->_rootref['L_FORUM'])) ? $this->_rootref['L_FORUM'] : ((isset($user->lang['FORUM'])) ? $user->lang['FORUM'] : '{ FORUM }')); if ($this->_rootref['FORUM_NAME']) {  ?> - <?php echo (isset($this->_rootref['FORUM_NAME'])) ? $this->_rootref['FORUM_NAME'] : ''; } } } else { echo (isset($this->_rootref['SITENAME'])) ? $this->_rootref['SITENAME'] : ''; } } else if ($this->_rootref['SCRIPT_NAME'] == ("ucp")) {  echo ((isset($this->_rootref['L_VIEWING_UCP'])) ? $this->_rootref['L_VIEWING_UCP'] : ((isset($user->lang['VIEWING_UCP'])) ? $user->lang['VIEWING_UCP'] : '{ VIEWING_UCP }')); ?> - <?php echo (isset($this->_rootref['PAGE_TITLE'])) ? $this->_rootref['PAGE_TITLE'] : ''; if ($this->_rootref['CUR_FOLDER_NAME']) {  echo (isset($this->_rootref['CUR_FOLDER_NAME'])) ? $this->_rootref['CUR_FOLDER_NAME'] : ''; } } else if ($this->_rootref['SCRIPT_NAME'] == ("mcp")) {  echo ((isset($this->_rootref['L_VIEWING_MCP'])) ? $this->_rootref['L_VIEWING_MCP'] : ((isset($user->lang['VIEWING_MCP'])) ? $user->lang['VIEWING_MCP'] : '{ VIEWING_MCP }')); if ($this->_rootref['PAGE_TITLE']) {  ?> - <?php echo (isset($this->_rootref['PAGE_TITLE'])) ? $this->_rootref['PAGE_TITLE'] : ''; } if ($this->_rootref['L_TITLE']) {  ?> - <?php echo ((isset($this->_rootref['L_TITLE'])) ? $this->_rootref['L_TITLE'] : ((isset($user->lang['TITLE'])) ? $user->lang['TITLE'] : '{ TITLE }')); } } else if ($this->_rootref['SCRIPT_NAME'] == ("faq")) {  echo ((isset($this->_rootref['L_VIEWING_FAQ'])) ? $this->_rootref['L_VIEWING_FAQ'] : ((isset($user->lang['VIEWING_FAQ'])) ? $user->lang['VIEWING_FAQ'] : '{ VIEWING_FAQ }')); ?> - <?php echo ((isset($this->_rootref['L_FAQ_TITLE'])) ? $this->_rootref['L_FAQ_TITLE'] : ((isset($user->lang['FAQ_TITLE'])) ? $user->lang['FAQ_TITLE'] : '{ FAQ_TITLE }')); ?>

    <?php } else if ($this->_rootref['SCRIPT_NAME'] == ("search")) {  echo ((isset($this->_rootref['L_SEARCH'])) ? $this->_rootref['L_SEARCH'] : ((isset($user->lang['SEARCH'])) ? $user->lang['SEARCH'] : '{ SEARCH }')); ?> <?php if ($this->_rootref['SEARCH_TITLE']) {  ?> - <?php echo (isset($this->_rootref['SEARCH_TITLE'])) ? $this->_rootref['SEARCH_TITLE'] : ''; } if ($this->_rootref['SEARCH_MATCHES']) {  ?> - <?php echo (isset($this->_rootref['SEARCH_MATCHES'])) ? $this->_rootref['SEARCH_MATCHES'] : ''; } ?> | <?php echo (isset($this->_rootref['SITENAME'])) ? $this->_rootref['SITENAME'] : ''; ?>

   <?php } else if ($this->_rootref['SCRIPT_NAME'] == ("memberlist")) {  if ($this->_rootref['S_USER_LOGGED_IN']) {  echo (isset($this->_rootref['PAGE_TITLE'])) ? $this->_rootref['PAGE_TITLE'] : ''; ?>

    <?php if ($this->_rootref['S_SHOW_GROUP']) {  ?> - <?php echo (isset($this->_rootref['GROUP_NAME'])) ? $this->_rootref['GROUP_NAME'] : ''; } ?> | <?php echo (isset($this->_rootref['SITENAME'])) ? $this->_rootref['SITENAME'] : ''; } else { echo (isset($this->_rootref['SITENAME'])) ? $this->_rootref['SITENAME'] : ''; } } else if ($this->_rootref['SCRIPT_NAME'] == ("chat")) {  echo ((isset($this->_rootref['L_VIEWING_CHAT'])) ? $this->_rootref['L_VIEWING_CHAT'] : ((isset($user->lang['VIEWING_CHAT'])) ? $user->lang['VIEWING_CHAT'] : '{ VIEWING_CHAT }')); ?>

   <?php } else { ?>Viewing Undefined page<?php } ?></title>
...
// <![CDATA[
	...
	var seo_external = <?php echo (isset($this->_rootref['SEO_EXTERNAL'])) ? $this->_rootref['SEO_EXTERNAL'] : ''; ?>;
	var seo_external_sub = <?php echo (isset($this->_rootref['SEO_EXTERNAL_SUB'])) ? $this->_rootref['SEO_EXTERNAL_SUB'] : ''; ?>;
	var seo_ext_classes = <?php echo (isset($this->_rootref['SEO_EXT_CLASSES'])) ? $this->_rootref['SEO_EXT_CLASSES'] : ''; ?>;
	var seo_hashfix = <?php echo (isset($this->_rootref['SEO_HASHFIX'])) ? $this->_rootref['SEO_HASHFIX'] : ''; ?>;
...
<link rel="shortcut icon" href="http://pkvartal.kiev.ua/forum/favicon.ico" />
<script type="text/javascript">

  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-35880465-1']);
	...
	<div id="page-header">
		...
		<?php } ?>
			...
			<div id="top-social">
				<div id="top-social-icons">
					<a href="http://pkvartal.kiev.ua/forum/feed.php"><img alt="RSS" title="RSS" src="http://pkvartal.kiev.ua/forum/styles/prosilver/imageset/rss-20.png"></a>
					<a href="http://www.facebook.com/pkvartal"><img alt="Facebook" title="Facebook" src="http://pkvartal.kiev.ua/forum/styles/prosilver/imageset/facebook-20.png"></a>
					<a href="https://twitter.com/PKvartal"><img alt="Twitter" title="Twitter" src="http://pkvartal.kiev.ua/forum/styles/prosilver/imageset/twitter-20.png"></a>
				</div>
			</div>
		...
		<div class="navbar">
			...
			<ul class="linklist navlinks">
				...
				<?php if ($this->_rootref['U_EMAIL_TOPIC']) {  ?><li class="rightside"><a href="<?php echo (isset($this->_rootref['U_EMAIL_TOPIC'])) ? $this->_rootref['U_EMAIL_TOPIC'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_EMAIL_TOPIC'])) ? $this->_rootref['L_EMAIL_TOPIC'] : ((isset($user->lang['EMAIL_TOPIC'])) ? $user->lang['EMAIL_TOPIC'] : '{ EMAIL_TOPIC }')); ?>" class="sendemail"><?php echo ((isset($this->_rootref['L_EMAIL_TOPIC'])) ? $this->_rootref['L_EMAIL_TOPIC'] : ((isset($user->lang['EMAIL_TOPIC'])) ? $user->lang['EMAIL_TOPIC'] : '{ EMAIL_TOPIC }')); ?></a></li><?php } if ($this->_rootref['U_EMAIL_PM']) {  ?><li class="rightside"><a href="<?php echo (isset($this->_rootref['U_EMAIL_PM'])) ? $this->_rootref['U_EMAIL_PM'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_EMAIL_PM'])) ? $this->_rootref['L_EMAIL_PM'] : ((isset($user->lang['EMAIL_PM'])) ? $user->lang['EMAIL_PM'] : '{ EMAIL_PM }')); ?>" class="sendemail"><?php echo ((isset($this->_rootref['L_EMAIL_PM'])) ? $this->_rootref['L_EMAIL_PM'] : ((isset($user->lang['EMAIL_PM'])) ? $user->lang['EMAIL_PM'] : '{ EMAIL_PM }')); ?></a></li><?php } if ($this->_rootref['U_PRINT_TOPIC']) {  ?><li class="rightside"><a href="<?php echo (isset($this->_rootref['U_PRINT_TOPIC'])) ? $this->_rootref['U_PRINT_TOPIC'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_PRINT_TOPIC'])) ? $this->_rootref['L_PRINT_TOPIC'] : ((isset($user->lang['PRINT_TOPIC'])) ? $user->lang['PRINT_TOPIC'] : '{ PRINT_TOPIC }')); ?>" accesskey="p" class="print"><?php echo ((isset($this->_rootref['L_PRINT_TOPIC'])) ? $this->_rootref['L_PRINT_TOPIC'] : ((isset($user->lang['PRINT_TOPIC'])) ? $user->lang['PRINT_TOPIC'] : '{ PRINT_TOPIC }')); ?></a></li><?php } if ($this->_rootref['U_PRINT_PM']) {  ?><li class="rightside"><a href="<?php echo (isset($this->_rootref['U_PRINT_PM'])) ? $this->_rootref['U_PRINT_PM'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_PRINT_PM'])) ? $this->_rootref['L_PRINT_PM'] : ((isset($user->lang['PRINT_PM'])) ? $user->lang['PRINT_PM'] : '{ PRINT_PM }')); ?>" accesskey="p" class="print"><?php echo ((isset($this->_rootref['L_PRINT_PM'])) ? $this->_rootref['L_PRINT_PM'] : ((isset($user->lang['PRINT_PM'])) ? $user->lang['PRINT_PM'] : '{ PRINT_PM }')); ?></a></li><?php } if ($this->_rootref['S_SHARE_TOPIC_ENABLED']) {  $_share_links_count = (isset($this->_tpldata['share_links'])) ? sizeof($this->_tpldata['share_links']) : 0;if ($_share_links_count) {for ($_share_links_i = 0; $_share_links_i < $_share_links_count; ++$_share_links_i){$_share_links_val = &$this->_tpldata['share_links'][$_share_links_i]; ?>

          				<li class="rightside"><a href="javascript:void(0)" onclick="window.open('<?php echo $_share_links_val['S_URL']; ?>', 'Share your link','width=500,height=300,menubar=no,status=no,location=no,toolbar=no,scrollbars=no')"><img src="<?php echo $_share_links_val['S_IMG_URL']; ?>" alt="" style="max-width: 18px; max-height: 18px;" /></a></li>
        				<?php }} } ?>
