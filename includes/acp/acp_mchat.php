	...
	function configuration ()
	{
		...
		if ($submit)
		{
			...
			if (!sizeof($error))
			{
				...
				//mchat widget
				set_config('mchat_on_index_widget', request_var('mchat_on_index_widget', 0));
		...
		$mchat_on_index_widget = isset($config['mchat_on_index_widget']) ? $config['mchat_on_index_widget'] : 0;
		...
		$template->assign_vars(array(
			...
			'MCHAT_ON_INDEX_WIDGET'				=> ($mchat_on_index_widget) ? true : false,
