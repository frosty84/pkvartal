...
$lang = array_merge($lang, array(
	'RECENT_TOPICS'						=> 'Последние обсуждения',
	'NO_ADS'						=> 'Скрыть рекламу',
	'SHOW_ADS'						=> 'Показывать рекламу',
	'SHOW_ADS_DESCR'					=> 'Покaзывать сообщенния из ветки \'Реклама\' в последних обсуждениях',
	'NO_ADS_DESCR'						=> 'Сообщенния из ветки \'Реклама\' не будут показаны в последних обсуждениях',
	'RECENT_TOPICS_MOD'					=> '"Последние обсуждения" MOD',
	'RT_CONFIG'							=> 'Конфигурация',
	'RT_ANTI_TOPICS'					=> 'Исключенные топики',
	'RT_ANTI_TOPICS_EXP'				=> 'Seperated by ", " (Example: "7, 9")<br />If you don\'t want to exclude a topic, just enter 0.',
	'RT_NUMBER'							=> 'Последние обсуждения',
